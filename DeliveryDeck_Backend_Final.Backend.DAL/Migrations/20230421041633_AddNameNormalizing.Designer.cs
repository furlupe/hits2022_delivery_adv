...
namespace DeliveryDeck_Backend_Final.Backend.DAL.Migrations
{
    ...
    [Migration("20230421041633_AddNameNormalizing")]
    partial class AddNameNormalizing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeliveryDeck_Backend_Final.Backend.DAL.Entities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6608e3e4-7aae-4117-8087-65869596e203"),
                            Cooks = new List<Guid>(),
                        ...
                        new
                        {
                            Id = new Guid("87621f17-a454-4291-b60c-a616254b8828"),
                            Cooks = new List<Guid>(),
                            Managers = new List<Guid>(),
                            Name = "Old Amogus",
                        ...
                        new
                        {
                            Id = new Guid("de5ae06d-d9fb-4087-99f6-93fdf82a2ee0"),
                            Cooks = new List<Guid>(),
                            Managers = new List<Guid>(),
                            Name = "FeastingHub",
