...
namespace DeliveryDeck_Backend_Final.Auth.DAL.Migrations
{
    ...
    [Migration("20230418063922_InheritanceViaCrossReferences")]
    partial class InheritanceViaCrossReferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("DeliveryDeck_Backend_Final.Auth.DAL.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
